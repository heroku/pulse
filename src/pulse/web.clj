...
(def graphs-index
  [[["nginx req/sec"       "nginx-requests-per-second"]
    ["nginx 500 app/min"   "nginx-500-apps-per-minute"]
    ["nginx 502 app/min"   "nginx-502-apps-per-minute"]
    ["nginx 503 app/min"   "nginx-503-apps-per-minute"]
    ["nginx 504 app/min"   "nginx-504-apps-per-minute"]
